...
export const stepSchemas = {
  ...
  7: z.object({
    ...
    guideType: z.enum(['guide', 'driver', 'host', 'nobody']),
  ...
  11: z.object({
    meetingPoint: locationPointSchema.nullable(),
  ...
  12: z.object({
    ...
    if (data.pricingModel === 'perPerson') {
      ...
      if (!data.pricingTiers || data.pricingTiers.length === 0) return
    ...
    if (data.pricingModel === 'perGroup') {
      if (!data.groupSizes || data.groupSizes.length === 0) {
