...
export const GYG_STEPS = [
  ...
  { id: 10, label: 'Photos', sectionId: 'media', stepId: 'photos' },
  { id: 11, label: 'Extra information', sectionId: 'product-content', stepId: 'extra-info' },
  { id: 12, label: 'Options', sectionId: 'option-setup', stepId: 'options' },
