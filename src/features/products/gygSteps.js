...
export const GYG_STEPS = [
  ...
  { id: 8, label: 'Transportation', sectionId: 'product-content', stepId: 'transportation' },
  { id: 9, label: 'Guide information', sectionId: 'product-content', stepId: 'guide-info' },
  { id: 10, label: 'Extra information', sectionId: 'product-content', stepId: 'extra-info' },
  { id: 11, label: 'Cancellation Policy', sectionId: 'product-content', stepId: 'cancellation-policy' },
  { id: 12, label: 'Photos', sectionId: 'media', stepId: 'photos' },
  { id: 13, label: 'Options', sectionId: 'option-setup', stepId: 'options' },
  { id: 14, label: 'Meeting Point or Pickup', sectionId: 'option-setup', stepId: 'meeting-point' },
  { id: 15, label: 'Itinerary Preview', sectionId: 'option-setup', stepId: 'itinerary-preview' },
  { id: 16, label: 'Pricing & Availability', sectionId: 'option-setup', stepId: 'pricing' },
  { id: 17, label: 'Cut-off', sectionId: 'option-setup', stepId: 'cutoff' },
]
